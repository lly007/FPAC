...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='fpac_seg_msg', help='model name [default: fpac_seg]')
    ...
    parser.add_argument('--log_dir', type=str, default='fpac_seg_'+now, help='Log path [default: fpac_seg_time]')
...
def main(args):
    ...
    shutil.copy('./fpac_seg.py', str(experiment_dir))
    shutil.copy('./pooling.py', str(experiment_dir))
    shutil.copy('./fpac6.py' , str(experiment_dir))
    ...
    for epoch in range(start_epoch,args.epoch):
        ...
        for i, data in tqdm(enumerate(trainDataLoader), total=len(trainDataLoader), smoothing=0.9):
            ...
            loss = criterion(seg_pred, target, 0)
            loss.backward()
            optimizer.step()
